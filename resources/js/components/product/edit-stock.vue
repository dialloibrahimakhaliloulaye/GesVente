...
<template>
    <div>
        <div class="row">
            <router-link to="/stock" class="btn btn-primary">Retour </router-link>
        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> Modifier stock</h1>
                                    </div>
                                    <form class="user" @submit.prevent="StockUpdate">
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <label for="exampleFormControlSelect1">Stock produit</label>
