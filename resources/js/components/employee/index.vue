                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr v-for="employee in filtersearch" :key="employee.id">
                                ...
                                <td>
                                    <router-link :to="{name: 'edit-employee', params:{id:employee.id}}" class="btn btn-sm btn-primary">Editer</router-link>

                                    <a @click="deleteEmployee(employee.id)" class="btn btn-sm btn-danger"><font color="#ffffff">Supprimer</font></a>
                                </td>
                            </tr>
