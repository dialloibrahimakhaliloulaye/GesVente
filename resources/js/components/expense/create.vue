...
<template>
    ...
    <div>
        <div class="row">
            <router-link to="/expense" class="btn btn-primary">Liste des dépenses </router-link>
        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Ajouter une dépense</h1>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12"><br>
                                                    <label for="exampleFormControlTextarea1"><b>Somme (FCFA)</b></label>
